...
const Companies = () => {
  return (
    <div className='pt-16 '>
      <p className='text-base text-gray-700 font-bold flex justify-center '>Trusted by learners from</p>
      <div className='flex flex-wrap items-center justify-center gap-6 md:gap-16 md:mt-10 mt-5'>
        ...
        <img src={assets.paypal_logo} alt="paypala" className='w-20 md:w-28'/>
