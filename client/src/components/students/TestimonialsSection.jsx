  ...
  return (
    <div className="pb-14 px-8 md:px-0 ">
      ...
      <p className="md:text-base text-gray-500 mt-3">
        Hear our learners as they share their jouney of transformation, success
        and how our <br /> platform has made difference in their lives.
      </p>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-4 px-5 py-4 bg-gray-300">
                <img
                  className="h-12 w-12 rouneded-full"
